...
const PATTERNS = [
    {
        ...
        severity: 'CRITICAL',
        message: 'Direct HTML injection detected. Use safe React components instead.'
    },
    {
        name: 'XSS: innerHTML',
        regex: /\.innerHTML\s*=/g,
    ...
    },
    {
        ...
        regex: /public\./g,
        severity: 'CRITICAL',
        message: 'Direct public schema access detected. S2 violation - use tenant-specific schemas.'
    },
    {
        name: 'Security: document.cookie',
        regex: /document\.cookie/g,
        severity: 'WARNING',
        message: 'Direct cookie access detected. Ensure HttpOnly flags are used via middleware.'
    }
];
