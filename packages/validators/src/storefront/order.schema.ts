...
export const AddressSchema = z.object({
    ...
    country: z.string()
        ...
        .toUpperCase()
        .regex(/^[A-Z]{2}$/, 'Country must be ISO 3166-1 alpha-2 format (e.g., US, SA)'),
...
export const OrderSchema = z.object({
    ...
    // Tracking
    // ═══════════════════════════════════════════════════════════
    trackingNumber: z.string().max(100, 'Tracking number cannot exceed 100 characters').nullable(),
    ...
    shippedAt: z.string().datetime({ message: 'Invalid datetime format' }).nullable(),
    deliveredAt: z.string().datetime({ message: 'Invalid datetime format' }).nullable(),
});
