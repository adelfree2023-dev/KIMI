                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link href="/categories/men" className="hover:text-white transition-colors">Men</Link></li>
                            <li><Link href="/categories/women" className="hover:text-white transition-colors">Women</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link href="/refund" className="hover:text-white transition-colors">Returns</Link></li>
                        </ul>
                    </div>
