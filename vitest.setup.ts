...
process.env.DATABASE_URL = process.env.CI_DATABASE_URL || 'postgresql://localhost:5432/test';
process.env.MINIO_ENDPOINT = process.env.CI_MINIO_ENDPOINT || 'localhost';
process.env.MINIO_ACCESS_KEY = process.env.CI_MINIO_ACCESS_KEY || generateTestSecret(20);
process.env.MINIO_SECRET_KEY = process.env.CI_MINIO_SECRET_KEY || generateTestSecret(40);
...
process.env.ENCRYPTION_MASTER_KEY = generateTestSecret(16) + 'A1!' + generateTestSecret(16);
